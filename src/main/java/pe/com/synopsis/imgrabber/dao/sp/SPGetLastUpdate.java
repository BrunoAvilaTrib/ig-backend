...
import pe.com.synopsis.imgrabber.dao.mapper.GetLastUpdateMapper;

@Component
public class SPGetLastUpdate extends CPStoredProcedure
{

    private static final String SP_NAME = "P_GET_LAST_UPDATE";
    ...
    @Autowired
    public SPGetLastUpdate(JdbcTemplate jdbcTemplate)
    {
    ...
    public void configSP()
    {
        getSimpleJdbcCall()
                ...
                .returningResultSet(OUT_CURSOR, new GetLastUpdateMapper());
    }
}
