...
import pe.com.synopsis.imgrabber.dao.mapper.LoadLastMessageMapper;

@Component
public class SPLoadLastMessage extends CPStoredProcedure
{

    private static final String SP_NAME = "P_LOAD_LAST_MESSAGE";
    ...
    @Autowired
    public SPLoadLastMessage(JdbcTemplate jdbcTemplate)
    {
    ...
    public void configSP()
    {
        getSimpleJdbcCall().useInParameterNames(IN_CHATID)
                ...
                .returningResultSet(OUT_CURSOR, new LoadLastMessageMapper());
    }
}
