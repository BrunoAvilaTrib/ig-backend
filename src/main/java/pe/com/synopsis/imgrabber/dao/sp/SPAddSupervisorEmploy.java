...
@Component
public class SPAddSupervisorEmploy extends CPStoredProcedure
{

    private static final String SP_NAME = "P_ADD_SUPERVISOR_EMPLOY";
    ...
    @Autowired
    public SPAddSupervisorEmploy(JdbcTemplate jdbcTemplate)
    {
    ...
    public void configSP()
    {
        getSimpleJdbcCall()
                .useInParameterNames(IN_NAME, IN_APPAT, IN_APMAT, IN_EMAIL, IN_PASSWORD, IN_SEX, IN_MOBILE,
                        IN_BUSINESS_FK, IN_ROLE_FK, IN_AREA_FK, IN_PRIVILEGE_STATE, IN_LOGIN_EMPLOY_PK)
                .declareParameters(new SqlOutParameter(OUT_STATUS, Types.VARCHAR),
                        ...
                        new SqlParameter(IN_ROLE_FK, Types.BIGINT), new SqlParameter(IN_AREA_FK, Types.BIGINT),
