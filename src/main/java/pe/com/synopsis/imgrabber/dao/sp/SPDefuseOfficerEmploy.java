...
@Component
public class SPDefuseOfficerEmploy extends CPStoredProcedure
{

    private static final String SP_NAME = "P_DEFUSE_OFFICER_EMPLOY";
    ...
    @Autowired
    public SPDefuseOfficerEmploy(JdbcTemplate jdbcTemplate)
    {
