...
@Component
public class SPDefuseSupervisorEmploy extends CPStoredProcedure
{

    private static final String SP_NAME = "P_DEFUSE_SUPERVISOR_EMPLOY";
    ...
    @Autowired
    public SPDefuseSupervisorEmploy(JdbcTemplate jdbcTemplate)
    {
