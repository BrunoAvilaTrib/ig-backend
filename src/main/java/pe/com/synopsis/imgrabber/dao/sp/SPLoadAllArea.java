...
import pe.com.synopsis.imgrabber.dao.mapper.LoadAllAreaMapper;

@Component
public class SPLoadAllArea extends CPStoredProcedure
{

    private static final String SP_NAME = "P_LOAD_ALL_AREA";
    ...
    @Autowired
    public SPLoadAllArea(JdbcTemplate jdbcTemplate)
    {
    ...
    public void configSP()
    {
        getSimpleJdbcCall().useInParameterNames(IN_LOGIN_EMPLOY_PK)
                ...
                .returningResultSet(OUT_CURSOR, new LoadAllAreaMapper());
    }
}
