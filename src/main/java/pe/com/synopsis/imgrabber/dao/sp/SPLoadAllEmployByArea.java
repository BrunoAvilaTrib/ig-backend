...
@Component
public class SPLoadAllEmployByArea extends CPStoredProcedure
{

    private static final String SP_NAME = "P_LOAD_ALL_EMPLOY_BY_AREA";
    ...
    @Autowired
    public SPLoadAllEmployByArea(JdbcTemplate jdbcTemplate)
    {
    ...
    {
        getSimpleJdbcCall().useInParameterNames(IN_AREA_FK, IN_LOGIN_EMPLOY_PK)
                .declareParameters(new SqlOutParameter(OUT_STATUS, Types.VARCHAR),
                        new SqlParameter(IN_AREA_FK, Types.BIGINT), new SqlParameter(IN_LOGIN_EMPLOY_PK, Types.BIGINT))
