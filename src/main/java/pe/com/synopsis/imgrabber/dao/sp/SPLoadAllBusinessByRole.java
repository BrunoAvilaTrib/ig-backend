...
import pe.com.synopsis.imgrabber.dao.mapper.LoadAllBusinessByRoleMapper;

@Component
public class SPLoadAllBusinessByRole extends CPStoredProcedure
{

    private static final String SP_NAME = "P_LOAD_ALL_BUSINESS_BY_ROLE";
    ...
    @Autowired
    public SPLoadAllBusinessByRole(JdbcTemplate jdbcTemplate)
    {
    ...
    public void configSP()
    {
        getSimpleJdbcCall().useInParameterNames(IN_LOGIN_EMPLOY_PK)
                ...
                .returningResultSet(OUT_CURSOR, new LoadAllBusinessByRoleMapper());
    }
}
