...
import pe.com.synopsis.imgrabber.dao.mapper.LoadAllEmployMapper;

@Component
public class SPLoadAllEmploy extends CPStoredProcedure
{

    private static final String SP_NAME = "P_LOAD_ALL_EMPLOY";
    ...
    @Autowired
    public SPLoadAllEmploy(JdbcTemplate jdbcTemplate)
    {
    ...
    public void configSP()
    {
        getSimpleJdbcCall().useInParameterNames(IN_LOGIN_EMPLOY_PK)
                ...
                .returningResultSet(OUT_CURSOR, new LoadAllEmployMapper());
    }
