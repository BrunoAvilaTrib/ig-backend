...
@Component
public class SPUpdateSupervisorEmploy extends CPStoredProcedure
{

    private static final String SP_NAME = "P_UPDATE_SUPERVISOR_EMPLOY";
    ...
    @Autowired
    public SPUpdateSupervisorEmploy(JdbcTemplate jdbcTemplate)
    {
    ...
    {
        getSimpleJdbcCall()
                .useInParameterNames(IN_EMPLOY_PK, IN_PASSWORD, IN_NAME, IN_APPAT, IN_APMAT, IN_SEX, IN_MOBILE,
                        IN_EMAIL, IN_AREA_FK, IN_PRIVILEGE_STATE, IN_LOGIN_EMPLOY_PK)
                .declareParameters(new SqlOutParameter(OUT_STATUS, Types.VARCHAR),
                        ...
                        new SqlParameter(IN_APMAT, Types.VARCHAR), new SqlParameter(IN_SEX, Types.VARCHAR),
                        new SqlParameter(IN_MOBILE, Types.VARCHAR), new SqlParameter(IN_EMAIL, Types.VARCHAR),
                        new SqlParameter(IN_AREA_FK, Types.BIGINT), new SqlParameter(IN_PRIVILEGE_STATE, Types.VARCHAR),
